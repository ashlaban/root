...
void TMVA::MethodCrossEvaluation::DeclareOptions()
{
   ...
   DeclareOptionRef( fOutputEnsembling = TString("Avg"), "OutputEnsembling", "Combines output from contained methods. If None, no combination is performed. (default None)");
